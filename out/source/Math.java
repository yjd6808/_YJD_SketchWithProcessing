...
public void _darw_epilogue()
{
}

public void _draw_axis(int _axisCount)
{
    if (_axisCount <= 2)
    {
...
public void _draw_vector(PVector _src, PVector _dst)
{
    stroke(0);
    strokeWeight(2);
...
public void _stroke(int _color)
{
    stroke(COLORS[_color].x, COLORS[_color].y, COLORS[_color].z);
}

public void _fill(int _color)
{
    fill(COLORS[_color].x, COLORS[_color].y, COLORS[_color].z);
}

public void _line_dotted(PVector _start, PVector _end, float _spacing, int _color)
{
...
public void _line_solid(PVector _start, PVector _end, int _color)
{
    pushStyle();
    _stroke(_color);
...
public void _line_native(PVector _start, PVector _end)
{
    line(_start.x, _start.y, _start.z, _end.x, _end.y, _end.z);
}

public PVector _add(PVector _src, PVector _dst) 
{ 
    return PVector.add(_src, _dst); 
}

public PVector _sub(PVector _src, PVector _dst) 
{ 
    return PVector.sub(_src, _dst); 
}

public PVector _mul(PVector _src, float _scalar) 
{ 
    return PVector.mult(_src, _scalar); 
}

public PVector _normalize(PVector _src) 
{ 
...
public void _sphere(PVector _pos, float _radious, int _color)
{
    pushMatrix();
    _fill(_color);
    _stroke(_color);
...
public void _point(PVector _pos, int _color)
{
    _sphere(_pos, POINT_SIZE / 2.0f, _color);
}

public void _point(float _x, float _y, float _z, int _color)
{
    _sphere(new PVector(_x, _y, _z), POINT_SIZE / 2.0f, _color);
}


  public void settings() { size(600, 800, P3D); }
